...
int main(int argc, char* argv[])
{
	...
	setlocale(LC_ALL, "");
        ...
        wcout << endl<< "prime number p: " << integer_to_wstring(p1) << endl;
        wcout << endl<< "prime number q: " << integer_to_wstring(q1) << endl;
        wcout << endl<< "public exponent e: " << integer_to_wstring(e1) << endl;
